...
class RuleTesterTestCase(CleanDbTestCase):
    def test_matching_trigger_from_file(self):
        ...
        tester = RuleTester(
            rule_file_path=rule_file_path, trigger_instance_file_path=trigger_instance_file_path
        )
    ...
    def test_matching_trigger_from_db(self):
        ...
        tester = RuleTester(rule_ref=rule_db.ref, trigger_instance_id=str(trigger_instance_db.id))
        matching = tester.evaluate()
        self.assertTrue(matching)
