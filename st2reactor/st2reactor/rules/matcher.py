...
class RulesMatcher(object):
    ...
    def get_matching_rules(self):
        ...
        # second pass
        rule_filters = [
            SecondPassRuleFilter(self.trigger_instance, self.trigger, rule, matched_rules)
        ...
        LOG.info('%d rule(s) found to enforce for %s.', len(matched_rules), self.trigger['name'])
