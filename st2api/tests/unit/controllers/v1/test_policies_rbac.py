...
__all__ = ['PolicyTypeControllerRBACTestCase', 'PolicyControllerRBACTestCase']
...
TEST_FIXTURES = {
    ...
    'policies': ['policy_1.yaml', 'policy_2.yaml', 'policy_8.yaml'],
}
...
class PolicyTypeControllerRBACTestCase(APIControllerWithRBACTestCase):
    ...
    def setUp(self):
        ...
        PolicyTypeControllerRBACTestCase.POLICY_TYPE_1 = self.fixtures_loader.load_fixtures(
            fixtures_pack=FIXTURES_PACK, fixtures_dict={'policytypes': [file_name]}
        )['policytypes'][file_name]
    ...
    def test_get_all_no_permissions(self):
        ...
        expected_msg = (
            'User "no_permissions" doesn\'t have required permission ' '"policy_type_list"'
        )
    ...
    def test_get_one_no_permissions(self):
        ...
        expected_msg = (
            'User "no_permissions" doesn\'t have required permission "policy_type_view"'
    ...
    def test_get_all_permission_success_get_one_no_permission_failure(self):
        ...
        resp = self.app.get('/v1/policytypes/%s' % (policy_type_id), expect_errors=True)
        expected_msg = (
            'User "policy_type_list" doesn\'t have required permission '
    ...
    def test_get_one_permission_success_get_all_no_permission_failure(self):
        ...
        resp = self.app.get('/v1/policytypes', expect_errors=True)
        expected_msg = (
            'User "policy_type_view" doesn\'t have required permission ' '"policy_type_list"'
        )
        self.assertEqual(resp.status_code, http_client.FORBIDDEN)
        self.assertEqual(resp.json['faultstring'], expected_msg)
        ...
        expected_msg = (
            'User "policy_type_view" doesn\'t have required permission '
            '"policy_type_view" on resource "%s"' % (policy_type_uid)
        )
        resp = self.app.get('/v1/policytypes/%s' % (policy_type_id), expect_errors=True)
        self.assertEqual(resp.status_code, http_client.FORBIDDEN)
...
class PolicyControllerRBACTestCase(APIControllerWithRBACTestCase):
    ...
    def setUp(self):
        ...
        PolicyControllerRBACTestCase.POLICY_1 = self.fixtures_loader.load_fixtures(
            fixtures_pack=FIXTURES_PACK, fixtures_dict={'policies': [file_name]}
        )['policies'][file_name]
        ...
        permission_grants = [str(grant_db.id)]
        role_1_db = RoleDB(
            name='policy_view_policy8_parent_pack', permission_grants=permission_grants
        )
        role_1_db = Role.add_or_update(role_1_db)
        ...
        permission_grants = [str(grant_db.id)]
        role_1_db = RoleDB(
            name='policy_create_policy8_parent_pack', permission_grants=permission_grants
        )
        role_1_db = Role.add_or_update(role_1_db)
        ...
        permission_grants = [str(grant_db.id)]
        role_1_db = RoleDB(
            name='policy_delete_policy8_parent_pack', permission_grants=permission_grants
        )
        role_1_db = Role.add_or_update(role_1_db)
    ...
    def test_get_all_no_permissions(self):
        ...
        expected_msg = 'User "no_permissions" doesn\'t have required permission ' '"policy_list"'
        self.assertEqual(resp.status_code, http_client.FORBIDDEN)
        self.assertEqual(resp.json['faultstring'], expected_msg)
    ...
    def test_get_one_no_permissions(self):
        ...
        expected_msg = (
            'User "no_permissions" doesn\'t have required permission "policy_view"'
    ...
    def test_get_all_permission_success_get_one_no_permission_failure(self):
        ...
        resp = self.app.get('/v1/policies/%s' % (policy_id), expect_errors=True)
        expected_msg = (
            'User "policy_list" doesn\'t have required permission "policy_view"'
            ' on resource "%s"' % (policy_uid)
        )
        self.assertEqual(resp.status_code, http_client.FORBIDDEN)
        self.assertEqual(resp.json['faultstring'], expected_msg)
    ...
    def test_get_one_permission_success_get_all_no_permission_failure(self):
        ...
        resp = self.app.get('/v1/policies', expect_errors=True)
        expected_msg = (
            'User "policy_view_direct_policy1" doesn\'t have required permission ' '"policy_list"'
        )
        self.assertEqual(resp.status_code, http_client.FORBIDDEN)
        self.assertEqual(resp.json['faultstring'], expected_msg)
        ...
        resp = self.app.get('/v1/policies/%s' % (policy_id), expect_errors=True)
        expected_msg = (
            'User "policy_view_direct_policy1" doesn\'t have required permission'
        ...
        resp = self.app.get('/v1/policies/%s' % (policy_id), expect_errors=True)
        expected_msg = (
            'User "policy_view_policy8_parent_pack" doesn\'t have required permission'
            ' "policy_view" on resource "%s"' % (policy_uid)
        )
        self.assertEqual(resp.status_code, http_client.FORBIDDEN)
        self.assertEqual(resp.json['faultstring'], expected_msg)
    ...
    def test_policy_update_no_permissions(self):
        ...
        expected_msg = (
            'User "no_permissions" doesn\'t have required permission "policy_modify"'
            ' on resource "%s"' % (policy_uid)
        )
        self.assertEqual(resp.status_code, http_client.FORBIDDEN)
        self.assertEqual(resp.json['faultstring'], expected_msg)
    ...
    def test_policy_delete_no_permissions(self):
        ...
        resp = self.app.delete('/v1/policies/%s' % (policy_id), expect_errors=True)
        expected_msg = (
            'User "no_permissions" doesn\'t have required permission "policy_delete"'
            ' on resource "%s"' % (policy_uid)
        )
        self.assertEqual(resp.status_code, http_client.FORBIDDEN)
        self.assertEqual(resp.json['faultstring'], expected_msg)
