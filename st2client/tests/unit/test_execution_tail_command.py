...
MOCK_LIVEACTION_4_CHILD_1_RUNNING = {
    'id': 'idmistralchild1',
    'context': {'mistral': {'task_name': 'task_1'}, 'parent': {'execution_id': 'idfoo4'}},
    'status': LIVEACTION_STATUS_RUNNING,
}

MOCK_LIVEACTION_4_CHILD_1_1_RUNNING = {
    'id': 'idmistralchild1_1',
    'context': {'mistral': {'task_name': 'task_1'}, 'parent': {'execution_id': 'idmistralchild1'}},
    'status': LIVEACTION_STATUS_RUNNING,
}
...
MOCK_LIVEACTION_4_CHILD_2_RUNNING = {
    'id': 'idmistralchild2',
    'context': {'mistral': {'task_name': 'task_2'}, 'parent': {'execution_id': 'idfoo4'}},
    'status': LIVEACTION_STATUS_RUNNING,
}
...
class ActionExecutionTailCommandTestCase(BaseCLITestCase):
    ...
    @mock.patch.object(
        ...
        'get',
        mock.MagicMock(
            return_value=base.FakeResponse(json.dumps(MOCK_LIVEACTION_1_SUCCEEDED), 200, 'OK')
        ),
    )
    ...
    @mock.patch.object(
        ...
        'get',
        mock.MagicMock(
            return_value=base.FakeResponse(json.dumps(MOCK_LIVEACTION_2_FAILED), 200, 'OK')
        ),
    )
    ...
    @mock.patch.object(
        ...
        'get',
        mock.MagicMock(
            return_value=base.FakeResponse(json.dumps(MOCK_LIVEACTION_1_RUNNING), 200, 'OK')
        ),
    )
...
"""
    ...
    @mock.patch.object(
        ...
        'get',
        mock.MagicMock(
            return_value=base.FakeResponse(json.dumps(MOCK_LIVEACTION_3_RUNNING), 200, 'OK')
        ),
    )
    @mock.patch('st2client.client.StreamManager', autospec=True)
...
""".lstrip()
    ...
    @mock.patch.object(
        ...
        'get',
        mock.MagicMock(
            return_value=base.FakeResponse(json.dumps(MOCK_LIVEACTION_4_RUNNING), 200, 'OK')
        ),
    )
    @mock.patch('st2client.client.StreamManager', autospec=True)
...
""".lstrip()
    ...
    @mock.patch.object(
        ...
        'get',
        mock.MagicMock(
            return_value=base.FakeResponse(json.dumps(MOCK_LIVEACTION_4_CHILD_2_RUNNING), 200, 'OK')
        ),
    )
    @mock.patch('st2client.client.StreamManager', autospec=True)
