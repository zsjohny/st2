...
RUNNER2 = {"enabled": True, "runner_parameters": {}, "name": "mock-runner2"}
...
LIVE_ACTION = {'action': 'mockety.mock', 'status': 'complete', 'result': {'stdout': 'non-empty'}}
...
class ActionCommandTestCase(base.BaseCLITestCase):
    ...
    def test_param_array_conversion_single_element_str(self):
        ...
        expected = {'action': 'mockety.mock2', 'user': None, 'parameters': {'list': ['one']}}
        httpclient.HTTPClient.post.assert_called_with('/executions', expected)
    ...
    def test_param_array_conversion_single_element_int(self):
        ...
        expected = {'action': 'mockety.mock2', 'user': None, 'parameters': {'list': [1]}}
        httpclient.HTTPClient.post.assert_called_with('/executions', expected)
    ...
    def test_param_dict_conversion_flag(self):
        ...
        self.shell.run(['run', 'mockety.mock2', 'list=key1:value1,key2:value2', '--auto-dict'])
        expected = {
            'action': 'mockety.mock2',
            'user': None,
