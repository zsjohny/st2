...
class Command(object):
    ...
    def __init__(self, name, description, app, subparsers, parent_parser=None, add_help=True):
        self.name = name
        self.description = description
        self.app = app
        self.parent_parser = parent_parser
        self.parser = subparsers.add_parser(
            self.name, description=self.description, help=self.description, add_help=add_help
        )
