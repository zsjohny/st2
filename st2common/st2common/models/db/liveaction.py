...
class LiveActionDB(stormbase.StormFoundationDB):
    ...
    action_is_workflow = me.BooleanField(
        default=False, help_text='A flag indicating whether the referenced action is a workflow.'
    )
    parameters = stormbase.EscapedDynamicField(
        default={}, help_text='The key-value pairs passed as to the action runner & execution.'
    )
    ...
    callback = me.DictField(
        default={}, help_text='Callback information for the on completion of action execution.'
    )
