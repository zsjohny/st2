...
class ActionAPI(BaseAPI, APIUIDMixin):
    ...
    schema = {
        ...
        "type": "object",
        "properties": {
            "id": {"description": "The unique identifier for the action.", "type": "string"},
            "ref": {
            ...
            "uid": {"type": "string"},
            "name": {"description": "The name of the action.", "type": "string", "required": True},
            "description": {"description": "The description of the action.", "type": "string"},
            "enabled": {
    ...
    schema['properties']['data_files'] = {
        ...
        'items': {
            ...
            'properties': {
                ...
                'content': {'type': 'string', 'description': 'Raw file content.', 'required': True},
            },
            'additionalProperties': False,
        },
        'default': [],
...
class ActionExecutionStateAPI(BaseAPI):
    ...
    def to_model(cls, state):
        ...
        model = cls.model(
            execution_id=execution_id, query_module=query_module, query_context=query_context
        )
        return model
...
class ActionAliasAPI(BaseAPI, APIUIDMixin):
    ...
    schema = {
        ...
        "type": "object",
        "properties": {
            "id": {"description": "The unique identifier for the action alias.", "type": "string"},
            "ref": {
...
class AliasExecutionAPI(BaseAPI):
    ...
    schema = {
        ...
        "properties": {
            ...
            "command": {"type": "string", "description": "Command used in chat.", "required": True},
            "user": {
                "type": "string",
...
class AliasMatchAndExecuteInputAPI(BaseAPI):
    ...
    schema = {
        ...
        "properties": {
            "command": {"type": "string", "description": "Command used in chat.", "required": True},
            "user": {"type": "string", "description": "User that requested the execution."},
            "source_channel": {
                "type": "string",
                "description": "Channel from which the execution was requested. This is not the \
                                channel as defined by the notification system.",
