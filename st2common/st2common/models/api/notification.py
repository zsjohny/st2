...
NotificationSubSchemaAPI = {
    ...
    "properties": {
        ...
        "data": {"type": "object", "description": "Data to be sent as part of notification"},
        "routes": {"type": "array", "description": "Channels to post notifications to."},
...
class NotificationsHelper(object):
    ...
    def _to_model_sub_schema(notification_settings_json):
        ...
        routes = notification_settings_json.get('routes', None) or notification_settings_json.get(
            'channels', []
        )
