...
MOCK_MASKED_ATTRIBUTES_BLACKLIST = ['blacklisted_1', 'blacklisted_2', 'blacklisted_3']
...
class ConsoleLogFormatterTestCase(unittest.TestCase):
    ...
    @mock.patch(
        'st2common.logging.formatters.MASKED_ATTRIBUTES_BLACKLIST', MOCK_MASKED_ATTRIBUTES_BLACKLIST
    )
    ...
    def test_format_secret_action_parameters_are_masked(self):
        ...
        expected_msg_part = (
            r"'parameters': {u?'parameter1': u?'value1', " r"u?'parameter2': u?'\*\*\*\*\*\*\*\*'}"
        )
