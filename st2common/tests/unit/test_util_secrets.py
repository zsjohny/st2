...
TEST_FLAT_SCHEMA = {
    ...
    'arg_optional_type_object': {'description': 'Who' 's the fairest of them?', 'type': 'object'},
}
...
TEST_NESTED_OBJECTS_SCHEMA = {
    'arg_string': {'description': 'Junk', 'type': 'string'},
    'arg_optional_object': {
        'description': 'Mirror',
        'type': 'object',
        'properties': {
            ...
            'arg_nested_secret': {'description': 'Deep down', 'type': 'string', 'secret': True},
        },
    },
}
...
TEST_NESTED_OBJECTS_SECRET_PARAMS = {
    'arg_optional_object': {
        ...
        'arg_nested_object': {'arg_double_nested_secret': 'string'},
    }
}
...
TEST_SECRET_ARRAY_SCHEMA = {
    'arg_secret_array': {'description': 'Mirror', 'type': 'array', 'secret': True}
}
...
TEST_SECRET_NESTED_ARRAYS_SCHEMA = {
    ...
    'arg_optional_double_array': {
        ...
        'type': 'array',
        'secret': True,
        'items': {'type': 'array', 'items': {'description': 'Deep down', 'type': 'string'}},
    },
    'arg_optional_tripple_array': {
        'description': 'Mirror',
        'type': 'array',
...
class SecretUtilsTestCase(unittest2.TestCase):
    ...
    def test_mask_secret_parameters_nested_objects(self):
        parameters = {
            'arg_optional_object': {
                ...
                'arg_nested_object': {'arg_double_nested_secret': 'double nested $ecret'},
            }
        }
    ...
    def test_mask_secret_parameters_array(self):
        parameters = {
            'arg_optional_array': ['$ecret $tring 1', '$ecret $tring 2', '$ecret $tring 3']
        }
    ...
    def test_mask_secret_parameters_nested_arrays(self):
        parameters = {
            'arg_optional_array': ['secret 1', 'secret 2', 'secret 3'],
            'arg_optional_double_array': [
                ['secret 4', 'secret 5', 'secret 6'],
                ['secret 7', 'secret 8', 'secret 9'],
            ],
            'arg_optional_tripple_array': [
        ...
        expected = {
            ...
            'arg_optional_double_array': [
                [MASKED_ATTRIBUTE_VALUE, MASKED_ATTRIBUTE_VALUE, MASKED_ATTRIBUTE_VALUE],
                [MASKED_ATTRIBUTE_VALUE, MASKED_ATTRIBUTE_VALUE, MASKED_ATTRIBUTE_VALUE],
            ],
            'arg_optional_tripple_array': [
                [
        ...
        parameters = {
            'arg_optional_object_with_double_array': {
                'arg_double_nested_array': [
                    ...
                    ['secret 4', 'secret 5', 'secret 6'],
                    ['secret 7', 'secret 8', 'secret 9', 'secret 10'],
                ]
            }
        }
        result = secrets.mask_secret_parameters(
    ...
    def test_mask_secret_parameters_secret_nested_arrays(self):
        ...
        expected = {
            ...
            'arg_optional_tripple_array': [MASKED_ATTRIBUTE_VALUE, MASKED_ATTRIBUTE_VALUE],
            'arg_optional_quad_array': [[MASKED_ATTRIBUTE_VALUE]],
        }
        self.assertEqual(expected, result)
